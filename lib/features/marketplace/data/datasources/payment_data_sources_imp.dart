...
class PaymentDataSourcesImp {
  ...
  Future<PaymentMethodModel> createPaymentMethod({
    ...
    try {
      ...
      throw Exception(
          e.error.localizedMessage ?? 'Error al crear método de pago');
    } catch (e) {
  ...
  Future<void> attachPaymentMethodToCustomer({
    ...
    try {
      ...
      final response = await client.post(
        Uri.parse(
            '$defaultApiServerStripe/payment_methods/$paymentMethodId/attach'),
  ...
  Future<void> detachPaymentMethod(String paymentMethodId) async {
    try {
      ...
      final response = await client.post(
        Uri.parse(
            '$defaultApiServerStripe/payment_methods/$paymentMethodId/detach'),
        headers: _stripeHeaders,
      );
  ...
  Future<void> deletePaymentback(int id, String token) async {
    try {
      Uri url =
          Uri.parse('${AppConstants.serverBase}/doctores/payment-methods/$id');
  ...
  Future<void> savecard(String paymentMethodId, String token) async {
    try {
      Uri url =
          Uri.parse('${AppConstants.serverBase}/doctores/payment-methods');
