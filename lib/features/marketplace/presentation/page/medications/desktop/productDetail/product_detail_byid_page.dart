...
Future<void> _openUrl(String url, ) async {
  try {
    if (url.isEmpty) {
      showErrorSnackbar('URL no disponible');
      return;
    }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Términos y condiciones - CON FUNCIONALIDAD
            ...
            // Ficha técnica - CON FUNCIONALIDAD
            ...
            // ... resto del código (botones de carrito y comprar)
            Column(
              children: [
                Obx(() {
...
class RelatedProductsCarousel extends StatelessWidget {
  ...
  // Método para convertir MedicationsEntity a Map<String, String>
