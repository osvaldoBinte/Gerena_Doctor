...
import 'package:gerena/features/marketplace/presentation/page/wishlist/ejemplo/ejemplo_controller.dart';
...
class SavedProductsContentmovil extends StatelessWidget {
  final VoidCallback onBackPressed;
  
  SavedProductsContentmovil({
    Key? key, 
    required this.onBackPressed,
  }) : super(key: key);
  
  final WishlistController2 controller = Get.put(WishlistController2());
