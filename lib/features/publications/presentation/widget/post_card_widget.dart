          ...
          Padding(
            ...
            child: Row(
              children: [
                CircleAvatar(
                  radius: 20,
                  backgroundImage: widget.userImageAsset.isNotEmpty &&
                          widget.userImageAsset.startsWith('http')
                      ? NetworkImage(widget.userImageAsset)
                      : (widget.userImageAsset.isNotEmpty
                          ? AssetImage(widget.userImageAsset)
                          : null),
                  child: widget.userImageAsset.isEmpty
