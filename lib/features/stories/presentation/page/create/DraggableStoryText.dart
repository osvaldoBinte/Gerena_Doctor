...
// import 'draggable_story_text.dart';
// import 'story_text_editor.dart';

// ✅ Widget de texto draggable (incluido inline por simplicidad)
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        onPanUpdate: (details) {
          setState(() {
            position = Offset(
              (position.dx * size.width + details.delta.dx) / size.width,
              (position.dy * size.height + details.delta.dy) / size.height,
            );
          });
        },
        onPanEnd: (_) {
