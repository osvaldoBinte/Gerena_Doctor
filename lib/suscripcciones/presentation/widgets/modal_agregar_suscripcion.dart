          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) return 'Campo requerido';
                  if (double.tryParse(value) == null) return 'El valor debe ser un número';
                  if (double.parse(value) <= 0) return 'El valor debe ser mayor a 0';
                  return null;
                },
                decoration: const InputDecoration(
                  labelText: 'Precio',
                  ...
                  if (_duracionSeleccionada == 'Personalizado')
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) {
                          if (_duracionSeleccionada != 'Personalizado') return null;
