...
class GerenaColors {
  ...
  static const Color primaryColor =
      Color(0xFF00535C); // Color principal verde azulado oscuro
  static const Color secondaryColor =
      Color(0xFF63C2A7); // Color secundario turquesa claro
  ...
  static const Color backgroundCalendar =
      Color(0xFF005B5F); // Fondo de calendario
  ...
  static const Color backgroundColor =
      Colors.white; // Fondo blanco como en las interfaces
  ...
  static const Color textPrimaryColor =
      Color(0xFF00535C); // Texto principal en verde azulado oscuro
  static const Color textSecondaryColor = Colors.grey;
  static const Color textTertiaryColor =
      Color(0xFF656565); // Texto terciario gris claro
  static const Color textpreviousprice =
      Color(0xFFFF4D4D); // Texto terciario gris claro

  static const Color textLightColor =
      Colors.white; // Texto en color claro para fondos oscuros
  static const Color textDarkColor = Color(0xFF004346);
  static const Color textchatDefault =
      Color(0xFFEDEDED); // Texto secundario claro
  static const Color textchatAnswer = Color(0xFFBAFFEB);
  static const Color textchat =
      Color(0xFF656565); // Texto de pregunta en gris claro
  static const Color textTertiary = Color(0xFF000000);
  static const Color textQuaternary = Color(0xFF00A6AD);
  static final Color loaddingwithOpacity1 =
      const Color.fromARGB(255, 200, 200, 200).withOpacity(0.15);
  static final Color loaddingwithOpacity3 =
      const Color.fromARGB(255, 180, 180, 180).withOpacity(0.35);
  ...
  static const Color colorAccionButtons =
      secondaryColor; // Botones de acción turquesa
  static const Color colorCancelar =
      Color(0xFFE0E0E0); // Gris claro para cancelar
  ...
  static final Color buttoninformation =
      Color(0xFF63C2A7); // Color para botones de información
  ...
  static ThemeData get themeData => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle:
              GoogleFonts.rubik(color: textSecondaryColor.withOpacity(0.7)),
        ),
  ...
  static Widget createAppLogo({
    ...
    return Builder(
      builder: (context) {
        ...
        EdgeInsets safePadding = padding ??
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  ...
                  height: constraints.maxHeight *
                      0.4, // 40% de la altura para la imagen
                  fit: BoxFit.cover,
                ),
              ),
...
// ← NUEVO MÉTODO AUXILIAR
  ...
  static Widget createDoctorCard(
    ...
    final String info = doctor['info'] ?? '';
    final String? rol = doctor['rol'];
    final int? experienceTime = doctor['experienceTime'];
    final int userId = doctor['userId'] ?? 0;

    // Determinar qué mostrar
    final bool hasSpecialty = specialty.isNotEmpty;
    ...
    // Función para obtener label del rol
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8),
                    child: _isNetworkImage(profileImage)
                        ? Image.network(
                            profileImage,
                            width: 80,
                            height: 80,
              ...
              Expanded(
                child: Column(
                  ...
                  if (rol != null) {
                    ...
                    if (hasRol) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: _getRolColor(rol).withOpacity(0.3),
                            width: 1,
                          ),
                        ),
                        child: Text(
                    ...
                    if (hasSpecialty) ...[
                      const SizedBox(height: 4),
                      Text(specialty, style: subtitleMedium),
                    ],
                    ...
                    if (hasExperience) ...[
                      const SizedBox(height: 4),
                      Text(
                        '$experienceTime años de experiencia',
                        style: bodySmall.copyWith(
                          color: textSecondaryColor,
                          fontSize: 11,
                        ),
