...
class MediaController extends GetxController {
  // Variables reactivas para almacenar los archivos
  ...
  Future<void> pickFiles() async {
    try {
      ...
      FilePickerResult? result = await FilePicker.platform.pickFiles(
        ...
        allowMultiple: true,
        withData: false, // Mejor rendimiento
      );
  ...
  Future<void> saveProcedure() async {
    try {
      ...
      // Aquí agregarías la lógica real de guardado:
  ...
  // Método para mostrar confirmación de limpiar
  ...
  @override
  void onClose() {
    // Limpiar recursos al cerrar el controller
    selectedImages.clear();
    selectedVideos.clear();
    super.onClose();
  }
