...
class SuscripccionesActivasMesContainer extends StatefulWidget {
  ...
  const SuscripccionesActivasMesContainer({
    super.key,
  ...
  @override
  State<SuscripccionesActivasMesContainer> createState() =>
      _SuscripccionesActivasMesContainerState();
}

class _SuscripccionesActivasMesContainerState extends State<SuscripccionesActivasMesContainer> {
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            height: 64,
            child: Text(
              "Suscripcciones activas este mes",
              style: TextStyle(
